        ...
        <AnimatePresence mode="wait">
          ...
          >
            <motion.div
              ...
              className="relative w-16 h-16 md:w-20 md:h-20 mx-auto -mt-10 md:-mt-12 rounded-full border-4 border-white dark:border-black overflow-hidden shadow-md"
            >
              <Image
            ...
            >
              ...
              >
                <motion.div
                  ...
                  whileTap={{ scale: 0.95 }}
                  className={`relative w-full h-full rounded-full cursor-pointer overflow-hidden transition-all duration-300 ${
                    i === activeIndex
